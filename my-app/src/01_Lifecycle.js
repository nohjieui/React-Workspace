 ...
 */
    ...
    /*
        ...
        props, state가 새로운 값으로 갱신되어 render()메서드가 호출되는 시점(setState사용시)을 캐치하여
        컴포넌트를 업데이트 할지 여부를 결정한다.
        ...
        이 함수는 부모 컴포넌트로부터 전달된 이전 props와 이전 state를 인자로 절달받음
        ===============================================================================================================================
        소멸과정과 연관된 함수
