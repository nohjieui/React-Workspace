...
/*
  JSX(JavascriptXML)문법 : javascript문법 안에서 HTML요소가 함께 들어가있는 형태의 언어
  ...
  따라서 개발자는 복잡한 자바스크립트 코드를 짤 필요없이 동적으로 추가되는 DOM요소를 단순 코드 선언만으도 만들 수 있다.
  (선언적 방식)
...
function App() {
  return (
    // <h2>start react</h2> 여기는 js 영역
    // return문안에 반환되는 값은 무조건 1개여야함
    // 위코드 실행시키면 오류남
    <div> {/* html요소 -> <div> : 선언적 방식으로 document.createElement("div") 구문이 실행됨 */}
      {/* //JSX문법 영역 -> JSX문법 영역안에서 주석을 사용하는 방법 */}
      {/* <h2>start react</h2> */}
